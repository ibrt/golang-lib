...
func TestMilli(t *testing.T) {
	...
	require.Equal(t, int64(1611459048861422), timez.UnixMicro(v))
	require.Equal(t, "2021-01-24T03:30:48.861422Z", timez.FromUnixMicro(0, 1611459048861422).UTC().Format(time.RFC3339Nano))
}
